<div>
    <x-header title="Sale Detail #{{ $sale->id }}" separator>
        <x-slot:actions>
            @if (auth()->user()->role === 'admin')
                <x-button icon="o-arrow-uturn-left" label="Back" link="/admin/sales" class="btn-ghost" />
            @elseif (auth()->user()->role === 'cashier')
                <x-button icon="o-arrow-uturn-left" label="Back" link="/cashier/sales" class="btn-ghost" />
            @elseif (auth()->user()->role === 'manager')
                <x-button icon="o-arrow-uturn-left" label="Back" link="/manager/sales" class="btn-ghost" />
            @endif
        </x-slot:actions>
    </x-header>
