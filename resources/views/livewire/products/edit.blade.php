<div>
    <x-header title="Edit Product" separator progress-indicator>
        <x-slot:actions>
            @if (auth()->user()->role === 'admin')
                <x-button icon="o-arrow-uturn-left" label="Back" link="/admin/products" class="btn-ghost" />
            @else
                <x-button icon="o-arrow-uturn-left" label="Back" link="/warehouse/products" class="btn-ghost" />
            @endif
        </x-slot:actions>
    </x-header>
